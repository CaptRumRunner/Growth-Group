...
st.markdown(
    ...
    '.version-tag {display:inline; text-align:left; color:#4b5563; font-size:0.68rem; margin-left:0.4rem; text-transform:none; letter-spacing:normal; font-weight:400;}'
...
def sign_up_dialog(category_name, signed_families, allergies):
    ...
    with c1:
        ...
        st.markdown(
            ...
            'div[role="dialog"] .st-key-dlg_cancel_btn button {'
            'background-color:#2a1418 !important; color:#f87171 !important; border:1px solid #7f1d1d !important;'
            '}</style>',
            unsafe_allow_html=True,
        )
    with c2:
        ...
        st.markdown(
            ...
            'div[role="dialog"] .st-key-dlg_confirm_btn button {'
            'background-color:#166534 !important; color:#ffffff !important; border:none !important; font-weight:800 !important;'
            '}</style>',
            unsafe_allow_html=True,
        )
    if current:
...
# ----------------------------------------------------------------------
st.markdown(
    '<style>.st-key-brandrow {margin-bottom: -0.7rem;}</style>',
    unsafe_allow_html=True,
)
